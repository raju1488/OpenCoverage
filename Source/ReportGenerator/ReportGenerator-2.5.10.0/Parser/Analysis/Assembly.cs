...
namespace Palmmedia.ReportGenerator.Parser.Analysis
{
    ...
    public class Assembly
    {
        ...
        public int Newlines => this.classes.Sum(c => c.NewLines);
        //public int TestedNewLines { get; set; }
        public int TestedNewLines => this.classes.Sum(c => c.TestedNewLines);

        public int modifyassemblies => (Newlines > 0) ? 1 : 0;

        public int NewCoverage => this.classes.Sum(c => c.NewCoverage);
